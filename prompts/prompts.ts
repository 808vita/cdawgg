 ...
 */
export const identifyProductsPromptWithoutGuard = `You are a helpful assistant who can extract information and present it concisely.
 ...
 */
export const identifyIssuesPromptWithoutGuard = `You are a helpful assistant who can extract information and present it concisely.
 ...
 */
export const identifyGoodHighlightsPromptWithoutGuard = `You are a helpful assistant who can extract information and present it concisely.
